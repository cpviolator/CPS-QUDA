...
public:
  ...
  //Begin QUDA_CPS
  //! Is sink smeared?
  int SmearedSnk() const { return qp_arg.smeared_snk; } 
  //! Is source smeared?
...
public:
  ...
  // CONSTRUCTORS
  QPropWMom(Lattice& lat, CommonArg* c_arg);
  QPropWMom(Lattice& lat, QPropWArg* arg, CommonArg* c_arg);
  QPropWMom(Lattice& lat, QPropWArg* arg, int* p, CommonArg* c_arg);
  QPropWMom(const QPropWMom& rhs);  //copy constructor

  //MANIPULATORS
  Complex& mom_src(int i) const;
  
  // operator functions
  QPropWMom& operator=(const QPropWMom& rhs);
  
  //Free prop
  void AllocateMsrc(); // Allocates memory for msrc
  void DeleteMsrc();    // Deallocates memory for msrc
...
class QPropWMomSrc : public QPropWMom {
...
class QPropWMomSrcSmeared: public QPropWMom {
...
public:
  ...
  // CONSTRUCTORS
  QPropWMomSrcSmeared(Lattice& lat, QPropWArg* arg, int *p,
...
class QPropWMomSrcDilutedSmeared: public QPropWMom {
...
public:
  ...
  // CONSTRUCTORS
  QPropWMomSrcDilutedSmeared(Lattice& lat, QPropWArg* arg, int *p,
			     QPropWGaussArg* g_arg, CommonArg* c_arg,
			     int *t_L, int t_index);
...
// Begin QUDA_CPS
class QPropWRandWallSrcDiluted : public QPropWRand
{
  public:
  
  QPropWRandWallSrcDiluted(Lattice& lat,  QPropWArg* arg, QPropWRandArg *r_arg, CommonArg* c_arg, int t_L[], int t_index);
...
class QPropWRandWallSrcSmeared : public QPropWRand
{
  public:
  
  QPropWRandWallSrcSmeared(Lattice& lat,  QPropWArg* arg, QPropWRandArg *r_arg, CommonArg* c_arg, QPropWGaussArg* gauss_arg);
...
class QPropWRandWallSrcDilutedSmeared : public QPropWRand
{
 ...
 public:
  QPropWRandWallSrcDilutedSmeared(Lattice& lat,  QPropWArg* arg, QPropWRandArg* r_arg, CommonArg* c_arg, QPropWGaussArg *g_arg, int t_L[], int t_index);
  const QPropWGaussArg &GaussArg(void) {return gauss_arg;}
  int   Gauss_N() const{return gauss_arg.gauss_N;}
  Float Gauss_W() const{return gauss_arg.gauss_W;};
